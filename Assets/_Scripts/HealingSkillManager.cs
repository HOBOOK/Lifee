...
public class HealingSkillManager : MonoBehaviour
{
	void Update ()
    {
        ...
        {
            //레벨
            this.transform.GetChild(0).GetChild(0).GetChild(i).GetChild(2).GetChild(0).GetComponent<Text>().text = User.healingLevel[i].ToString();
